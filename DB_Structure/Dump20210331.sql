...
INSERT INTO `qa_board` VALUES (1,1,'질문 테스트',1,NULL,'2021-03-31 10:05:32',NULL);
...
INSERT INTO `sessions` VALUES ('KyaGOfBbFGGM1YOlKdg4PSYl0I9WfSpV',1617264454,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"admin\",\"idx\":1}'),('MFk15xAds7Hy8UegbcsT7IzNS_LP_bRU',1617115147,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"admin2\"}'),('mICZ1ZrH-Y38E84SiX2e3K2JwvVh7NTb',1617185177,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"지현\",\"idx\":2}'),('mQ2RiFKo2S47L-fLNi1Hyx-zLko6Jyd2',1617275399,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"admin\",\"idx\":1}'),('pTfZouwWBieDQIg-AsHctuYn7RZ_UXZ7',1617182148,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"admin\",\"idx\":1}'),('wqfv3WGXfnen1QE8-Um278NhiVh8qwyr',1617107509,'{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"nickname\":\"admin\"}');
...
INSERT INTO `work_board` VALUES (1,'dfadf','dafa',1,30,30,'1;2;3;4;5;','2021-03-31 10:04:38','img',900,0);
...
# made by jiho park
SELECT `qa_board`.`idx`, `work_board_idx`, `question`, `questioner`,  `nickname` as 'questioner_nickname' , `answer`, `question_date`, `answer_date` FROM `qa_board` LEFT JOIN `users` on `users`.`idx` = `qa_board`.`questioner` WHERE `work_board_idx`= 1 ;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2021-03-31 20:12:13
